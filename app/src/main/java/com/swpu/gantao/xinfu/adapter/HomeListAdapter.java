...
public class HomeListAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public HomeListAdapter(Context context, ArrayList<GroupMessage> groupMessages) {
    ...
    private void valueSet(int position, ViewHolder holder) {
        ...
        holder.tv_time.setText(groupMessage.getFomarttedTime());
    }
